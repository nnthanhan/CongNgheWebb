                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Tên máy tính</th>
                            <th>Tên phiên bản</th>
                            <th>Người báo sự cố </th>
                            <th>Thời gian báo cáo </th>
                            <th>Mô tả chi tiết vấn đề </th>
                            <th>Mức độ sự cố </th>
                            <th>Trạng thái </th>
                            <th>Hoạt động</th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('issues.show',$issue->id)}}">
                                    <div><button class="btn btn-success">Xem </button></div>
                                </a>
                                <a href="{{route('issues.edit',$issue->id)}}"><button class="btn btn-warning">Sửa</button> </a>
